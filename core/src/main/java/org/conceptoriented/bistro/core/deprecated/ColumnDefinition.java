 ...
 * This class has to directly or indirectly encode all names needed for computing certain column definitionType like main table name, parameter path names, and maybe additional parameters like whether to add records.
 */
@Deprecated
